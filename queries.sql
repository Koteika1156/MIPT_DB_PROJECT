...
SELECT Material, COUNT(*) AS MaterialCount FROM Parts GROUP BY Material ORDER BY MaterialCount DESC LIMIT 1;
...
SELECT * FROM Parts WHERE Material = 'Сталь' ORDER BY Weight ASC LIMIT 1;

-- 10. Получить количество производимых деталей типа "Крепеж"
SELECT COUNT(*) FROM Parts WHERE Type = 'Крепеж';
